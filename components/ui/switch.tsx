  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-4 translate-x-0.5 rounded-full bg-background shadow-sm ring-0 transition-transform data-checked:translate-x-[18px] dark:bg-foreground dark:data-checked:bg-background"
      />
    </SwitchPrimitive.Root>
  )
}
