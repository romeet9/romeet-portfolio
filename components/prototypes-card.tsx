...
import { KpiBurst, KpiPlate, KpiShell, KpiText, q } from "@/components/kpi-parts";
 ...
 * 958x718 at (-283,-221), 13-0 burst 80x80 at (210,6), 21-0 eyebrow, Z-0 caption.
 *
 ...
 */
const DARK_RADIAL =
  "radial-gradient(circle at 50% 50%, rgba(32,32,32,0.88) 0%, rgba(28,28,28,0.96) 50%, rgba(25,25,25,1) 90%)";

export function PrototypesCard() {
  return (
    <KpiShell style={{ backgroundColor: "#191919" }}>
      <KpiPlate className="bg-[url('/kpi/terminal.png')]" width={429} height={250} x={-65} y={-32} />
